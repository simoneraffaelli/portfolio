...
const staticCommands: Record<string, string> = {
  ...
  "version": `portfolio v2.0.0 @ ${process.env.NEXT_PUBLIC_COMMIT_SHA ?? "dev"} (built with next.js)`,
  "-v": `portfolio v2.0.0 @ ${process.env.NEXT_PUBLIC_COMMIT_SHA ?? "dev"} (built with next.js)`,
  "--version": `portfolio v2.0.0 @ ${process.env.NEXT_PUBLIC_COMMIT_SHA ?? "dev"} (built with next.js)`,
